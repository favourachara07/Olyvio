...
export default function Sidebar() {
  ...
  return (
    <div className="border-r border-r-[#D9D9D9] bg-[#33333305] px-4 xl:px-6 2xl:px-8 py-6 w-48 xl:w-56 2xl:w-80 h-screen fixed flex flex-col">
            ...
            {section.items.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="flex items-center gap-2 rounded-lg px-2 py-1 xl:py-2 2xl:py-3 text-[12px] xl:text-xs 2xl:text-sm text-[#33333380] hover:bg-[#33333308] transition-colors duration-150 font-montserrat-alternates"
                >
