  ...
  return (
    <div className="h-screen w-full bg-white">
      <div className="w-full h-full flex">
        ...
        {/* Main Content Area */}
        <div className="w-full lg:ml-[18%] xl:md:ml-[17%] px-4 py-4 2xl:py-6 flex flex-col pb-20 md:pb-4">
          <div className="w-full flex flex-row items-center justify-between pb-4 xl:pb-8">
            <h1 className="text-[#33333390] text-sm 2xl:text-md font-montserrat-alternates">
              Olyvio / <span className="text-black">Dashboard</span>
            </h1>
